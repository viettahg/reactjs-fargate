  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/profile.png" alt="Pium" className="mb-4" width="140" height="140"/>

          <h1 className="mb-2 mt-0">Pium Sudhara</h1>
          <p>
            {" "}
            <Typed
              strings={[
          ...
          <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/pium-sudhara-karunasena-41554458/" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.facebook.com/pium.sudhara/" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-facebook"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://twitter.com/piumsudhara" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-twitter"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.instagram.com/pium_sudhara/" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-instagram"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://github.com/piumsudhara" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://piumsudhara.medium.com/" target="_blank" rel="noopener noreferrer">
